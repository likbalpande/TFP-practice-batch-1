...
// const { recipes } = data;
// const parent = document.querySelector("#root-parent");

// const createUI = (recipes) => {
...
// const addPara = (parent, text, customClass, customId) => {
//     const newPara = document.createElement("p");
//     newPara.innerText = text;

//     if (customClass) newPara.className = customClass;

//     if (customId) newPara.setAttribute("id", customId);

//     parent.appendChild(newPara);
// };

// const createCard = (container, recipe) => {
//     const card = document.createElement("div");
//     card.className = "card";

//     // ------------ func to change the inner things
//     addPara(card, recipe.name, "title");
//     addPara(card, recipe.prepTimeMinutes);
//     addPara(card, recipe.servings);
//     addPara(card, recipe.id);
//     addPara(card, recipe.difficulty);
//     addPara(card, recipe.cuisine);
...
// // ---------------------------- FUNCTION with iterable arguments (array like) (position matters) -----------------------------------------
// const { recipes } = data;
// const parent = document.querySelector("#root-parent");

// const addPara = (parent, text, customClass, customId, title) => {
//     const newPara = document.createElement("p");
//     newPara.innerText = text;
//     newPara.title = title;
//     if (customClass) newPara.className = customClass;
...
//     addPara(card, recipe.prepTimeMinutes);
//     addPara(card, recipe.servings);
//     addPara(card, recipe.id, null, "1");
//     addPara(card, recipe.difficulty);
//     addPara(card, recipe.cuisine, "", "", "You will eat this");
...
// // ---------------------------- FUNCTION with object argument (KEY matters) -----------------------------------------
// const { recipes } = data;
// const parent = document.querySelector("#root-parent");

// const addPara = (obj) => {
//     const newPara = document.createElement("p");
//     newPara.innerText = obj.text;
//     if (obj.title) newPara.title = obj.title;
//     if (obj.customClass) newPara.className = obj.customClass;
//     if (obj.customId) newPara.setAttribute("id", obj.customId);
//     obj.parent.appendChild(newPara);
// };
...
// ---------------------------- With DESTRUCTURING: FUNCTION with object argument (KEY matters) -----------------------------------------
...
// const addPara = (obj) => {
//     const { text, title, customClass, customId, parent } = obj;
//     const newPara = document.createElement("p");
//     newPara.innerText = text;
//     if (title) newPara.title = title;
//     if (customClass) newPara.className = customClass;
//     if (customId) newPara.setAttribute("id", customId);
//     parent.appendChild(newPara);
// };
...
// ---------------------------- DESTRUCTURING on the fly: FUNCTION with object argument (KEY matters) -----------------------------------------
...
// const addPara = ({ text, title, customClass, customId, parent }) => {
//     const newPara = document.createElement("p");
//     newPara.innerText = text;
//     if (title) newPara.title = title;
//     if (customClass) newPara.className = customClass;
...
// const createCard = (container, { name, cuisine, id }) => {
//     const card = document.createElement("div");
//     card.className = "card";

//     addPara({ parent: card, text: name, title: "THIS IS FAMOUS NAME", customClass: "card-title" });
//     addPara({ parent: card, text: cuisine });
//     addPara({ parent: card, text: id, customId: id });
...
// const createUI = (recipes) => {
//     const container = new DocumentFragment();
//     recipes.forEach((rec) => createCard(container, rec));
//     parent.appendChild(container);
// };

// createUI(recipes);

// ------------------ deletion by using card index -------------------------
...
const addButton = ({ parent, text, customClass, cardIndex }) => {
    const newButton = document.createElement("button");
    newButton.innerText = text;
    newButton.classList.add(customClass);
    const cb = () => {
...
const createCard = (container, { name, cuisine, id }, cardIndex) => {
    const card = document.createElement("div");
    card.className = "card";
    ...
    addPara({ parent: card, text: cuisine });
    addPara({ parent: card, text: id, customId: id });
    addButton({ parent: card, text: "Delete", customClass: "delete-button", cardIndex: cardIndex });
...
const createUI = (recipes) => {
    const container = new DocumentFragment();
    recipes.forEach((rec, idx) => createCard(container, rec, idx));
    parent.appendChild(container);
};
