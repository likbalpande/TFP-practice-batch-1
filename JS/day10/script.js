...
// ----------------------------------
// function to show UI - create cards
// create a card
// create data member (heading, button, text)
//
// function to delete
// ----------------------------------

const addParaElement = (card, text, className = "card-text") => {
    const paraElem = document.createElement("p");
    paraElem.innerHTML = text;
    paraElem.classList.add(className);
    card.appendChild(paraElem);
};

const createCard = (parent, { id, name, servings, difficulty, cuisine, ingredients, image }) => {
    const card = document.createElement("div");
    card.className = "card";

    addParaElement(card, id, "identifier");
    addParaElement(card, name, "title");
    addParaElement(card, servings);
    addParaElement(card, difficulty);
    addParaElement(card, cuisine);

    // ---------------- H.W. ---------------------------------------
    // addParaElement(cuisine, card);
    // what is your suggestion to fix these types of issues?
    //
    // const student1 = ["Likhilesh", "Delhi", "MERN", "C++", "PPA"];
    // const student2 = {
    //     name: "Likhilesh",
    //     city: "Delhi",
    //     stack: "MERN",
    ...
    //     org: "PPA",
    // };
    // console.log(student1[0], student1[1], student1[2], student1[3], student1[4]);
    // console.log(student2.name, student2.city, student2.stack, student2.lan, student2.org);
    // ---------------- H.W. ---------------------------------------
...
const createUI = (arr) => {
    ...
    arr.forEach((recipe) => createCard(tempContainer, recipe));
    rootParent.appendChild(tempContainer);
};
