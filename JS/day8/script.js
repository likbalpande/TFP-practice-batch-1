...
// destructuring (object and arrays are copied by reference)
...
//         cuisine: data.recipes[i].cuisine,
//     });
// }
// console.log(q2a);
...
// const q2a = [];
// const { recipes } = data;
// Object.keys() --> will get the keys out of that object
// what is the difference between objects and arrays? --> !!
// what are the keys recipes array? --> indexes --> [0, 1, 2, 3....]

// Object.keys(recipes).forEach((elem) => {
//     const { name, cuisine } = recipes[elem];
//     q2a.push({
//         name,
//         cuisine,
//     });
...
// const { recipes } = data;
// const q2a = recipes.map(({ name, cuisine }) => ({
//     newName: name,
//     newCuisine: cuisine,
// }));
// console.log(q2a);
...
// q2A - iii - 4
// const { recipes } = data;
// const q2a = recipes.map(({ name, cuisine }) => ({ name, cuisine }));
// console.log(q2a);
...
// const { recipes } = data;
// for (let i = 0; i < recipes.length; i++) {
//     const { name, cuisine, rating } = recipes[i];
//     if (rating > 4.5) {
//         q2a.push({
//             name,
//             cuisine,
...
// const { recipes } = data;
// recipes.forEach((elem) => {
//     const { name, cuisine, rating } = elem;
//     if (rating > 4.5) {
//         q2a.push({
//             name,
//             cuisine,
...
// const q2a = [];
// const { recipes } = data;
// recipes.forEach(({ name, cuisine, rating }) => {
//     if (rating > 4.5) {
//         q2a.push({ name, cuisine });
//     }
// });
// console.log(q2a);

// q2B - iii - pre-phase
// const arr = [12, 13, 7, 8, 20, 11, 21, 2];
// // filter (watchman) is like map but expects return to be boolean
...
// q2B - iii - 1
// const { recipes } = data;
// const res = recipes.filter(({ rating }) => {
//     if (rating > 4.5) {
//         return true;
//     } else return false;
// });
// const cleanData = res.map(({ name, cuisine }) => ({ name, cuisine }));
// console.log(cleanData);

// q2B - iv - 1
// const { recipes } = data;
// const cleanData = recipes.flatMap(({ name, cuisine, rating }) => {
//     if (rating > 4.5) {
//         return { name, cuisine };
//     } else return [];
// });
...
// q2c - 1 - pre
// const { recipes } = data;
// recipes.forEach(({ name, cuisine, tags }) => {
//     console.log("-", name, cuisine);
//     tags.forEach((singleTag) => {
//         console.log("---", singleTag);
//         if (singleTag == "Italian" || singleTag == "Indian") {
//             console.log("------>", "pushed");
//         }
//     });
// });
...
// // q2c - ii - 1
// const { recipes } = data;
// const filteredRecipes = recipes.filter(({ tags }) => {
//     let isPresent = false;
//     tags.forEach((singleTag) => {
//         if (singleTag == "Italian" || singleTag == "Indian") {
//             isPresent = true;
...
//     return isPresent;
// });
// const cleanData = filteredRecipes.map(({ name, cuisine }) => ({ name, cuisine }));
// console.log(cleanData);

// q2c - ii - 2
// const { recipes } = data;
// const result = recipes.flatMap(({ name, cuisine, tags }) => {
//     let isPresent = false;
//     tags.forEach((singleTag) => {
//         if (singleTag == "Italian" || singleTag == "Indian") {
//             isPresent = true;
...
// const { recipes } = data;
// const result = recipes.flatMap(({ name, cuisine, tags }) => {
//     let isPresent = tags.findIndex((singleTag) => singleTag == "Italian" || singleTag == "Indian");
//     if (isPresent != -1) {
//         return { name, cuisine };
//     } else return [];
// });
...
// const result = recipes.flatMap(({ name, cuisine, tags }) => {
//     let isPresent = tags.findIndex((singleTag) => singleTag == "Italian" || singleTag == "Indian");
//     return isPresent === -1 ? [] : { name, cuisine };
// });
// console.log(result);
...
const { recipes } = data;
const result = recipes.flatMap(({ name, cuisine, tags }) =>
    tags.findIndex((singleTag) => singleTag == "Italian" || singleTag == "Indian") === -1 ? [] : { name, cuisine }
);
console.log(result);
